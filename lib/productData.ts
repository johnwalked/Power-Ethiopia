...
export const GENERATORS: Generator[] = [
    ...
    // Adding more from the constants.ts Jan 2026 update
    {
        ...
        image: '/images/yunnei-large-stock.png',
        inStock: true,
        description: 'Large scale Yunnei industrial generator powered by YN6K560L-D20 engine.',
        voltage: '400/230V',
        phase: '3 Phase',
        fuelConsumption: '86 L/hr',
    ...
    },
    {
        ...
        image: '/images/yunnei-100kw.png',
        inStock: true,
        description: 'Efficient Yunnei power solution for medium enterprises.',
        voltage: '400/230V',
        phase: '3 Phase',
    ...
    },
    {
        ...
        powerKW: 77,
        type: 'Silent',
        image: '/images/yunnei-80kw-mdz110.png',
        inStock: true,
        description: 'Reliable Yunnei medium-range generator.',
        voltage: '400/230V',
        phase: '3 Phase',
    ...
    },
    {
        ...
        image: '/images/yunnei-50kw.png',
        inStock: true,
        description: 'Yunnei power generation for agriculture and small factories.',
        voltage: '400V',
        phase: '3 Phase',
        fuelConsumption: '13 L/hr',
        dimensions: '2000 x 900 x 1300 mm',
        weight: '1020 kg'
    },
    {
        ...
        powerKW: 38,
        type: 'Silent',
        image: '/images/yunnei-30kw-md40.png',
        inStock: true,
        description: 'Compact Yunnei silent generator pack.',
        voltage: '400V',
        phase: '3 Phase',
    ...
    },
    {
        ...
        image: '/images/yunnei-30kw-md40.png',
        inStock: true,
        description: 'Yunnei low-power silent solution.',
        voltage: '400V',
        phase: '3 Phase',
        fuelConsumption: '6.5 L/hr',
    ...
    },
    {
        ...
        powerKW: 23.1,
        type: 'Silent',
        image: '/images/yunnei-16kw-md25.png',
        inStock: true,
        description: 'Standard Yunnei prime power unit.',
        voltage: '400V',
        phase: '3 Phase',
    ...
    },
    {
        ...
        image: '/images/yunnei-16kw-md25.png',
        inStock: true,
        description: 'Entry-level Yunnei industrial power.',
        voltage: '400V',
        phase: '3 Phase',
        fuelConsumption: '5.2 L/hr',
    ...
    },
    {
        ...
        image: '/images/weichai-500kw.png',
        inStock: true,
        description: 'Heavy duty Weichai energy solution.',
        voltage: '400V',
        phase: '3 Phase',
        fuelConsumption: '88 L/hr',
    ...
    },
    {
        ...
        image: '/images/weichai-500kw.png',
        inStock: true,
        description: 'Industrial Weichai silent generator.',
        voltage: '400V',
        phase: '3 Phase',
        fuelConsumption: '82 L/hr',
    ...
    },
    {
        ...
        image: '/images/weichai-500kw.png',
        inStock: true,
        description: 'Reliable Weichai prime power unit.',
        voltage: '400V',
        phase: '3 Phase',
        fuelConsumption: '70 L/hr',
    ...
    },
    {
        ...
        image: '/images/last-brand-silent.png',
        inStock: true,
        description: 'Last brand high-efficiency power set.',
        voltage: '400V',
        phase: '3 Phase',
    ...
    },
    {
        ...
        image: '/images/last-brand-silent.png',
        inStock: true,
        description: 'Economical Last brand silent generator.',
        voltage: '400V',
        phase: '3 Phase',
        fuelConsumption: '26 L/hr',
        dimensions: '2400 x 1000 x 1600 mm',
        weight: '1450 kg'
    },
    {
        ...
        image: '/images/last-brand-silent.png',
        inStock: true,
        description: 'Medium power Last brand unit.',
        voltage: '400V',
        phase: '3 Phase',
        fuelConsumption: '20 L/hr',
        dimensions: '2200 x 950 x 1450 mm',
    ...
    },
    {
        ...
        image: '/images/last-brand-silent.png',
        inStock: true,
        description: 'Small commercial Last brand generator.',
        voltage: '400V',
        phase: '3 Phase',
        fuelConsumption: '10 L/hr',
    ...
    },
    {
        ...
        image: '/images/last-brand-silent.png',
        inStock: true,
        description: 'Entry-level Last brand silent generator.',
        voltage: '400V',
        phase: '3 Phase',
        fuelConsumption: '6.5 L/hr',
    ...
    },
    {
        ...
        powerKW: 180,
        type: 'Silent',
        image: '/images/kefo-large-silent.png',
        inStock: true,
        description: 'High performance Kefo industrial unit.',
        voltage: '400V',
        phase: '3 Phase',
        fuelConsumption: '46 L/hr',
    ...
    },
    {
        ...
        image: '/images/kefo-large-silent.png',
        inStock: true,
        description: 'Standard Kefo power solution for construction.',
        voltage: '400V',
        phase: '3 Phase',
        fuelConsumption: '30 L/hr',
    ...
    },
    {
        ...
        image: '/images/kefo-large-silent.png',
        inStock: true,
        description: 'Powerful Kefo generator for mining.',
        voltage: '400V',
        phase: '3 Phase',
    ...
    },
    {
        ...
        image: '/images/yuchai-100kw.png',
        inStock: true,
        description: 'Premium Yuchai engine generator set.',
        voltage: '400V',
        phase: '3 Phase',
    ...
    },
    {
        ...
        image: '/images/yuchai-100kw.png',
        inStock: true,
        description: 'Efficient Yuchai power for medium businesses.',
        voltage: '400V',
        phase: '3 Phase',
        fuelConsumption: '22 L/hr',
    ...
    },
    {
        ...
        image: '/images/united-power-silent.png',
        inStock: true,
        description: 'Ultra-silent United Power backup.',
        voltage: '220V',
        phase: 'Single Phase',
    ...
    },
    {
        ...
        image: '/images/united-power-silent.png',
        inStock: true,
        description: 'Small household United Power unit.',
        voltage: '220V',
        phase: 'Single Phase',
        fuelConsumption: '2.2 L/hr',
        dimensions: '1050 x 620 x 900 mm',
        weight: '215 kg'
    }
];
...
export const PUMPS: WaterPump[] = [
    ...
    // Adding more pumps from constants.ts
    {
        ...
        maxHead: 120,
        flowRate: 800,
        image: '/images/pump-120kw-open.png',
        inStock: true,
    ...
    },
    {
        ...
        maxHead: 105,
        flowRate: 530,
        image: '/images/weichai-pump-300.png',
        inStock: true,
    ...
    },
    {
        ...
        image: '/images/cep-50p.png',
        inStock: true,
        description: 'Compact diesel pump for household irrigation and water transfer.',
        specs: { suction: '7m', fuelTank: '12L', engineModel: 'UP-Q11', startSystem: 'Electric' }
    }
];
